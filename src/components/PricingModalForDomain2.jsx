...
const PricingModalForDomain2 = ({ onClose, domain, tld , handleSubmit, email, checkoutType }) => {
  ...
  const amount = pricing?.register ?? 'N/A';
...
// const PricingModalForDomain2 = ({ isOpen, onClose, domain, tld }) => {
//   const { domainPricings } = useContext(Context);
//   const pricing = domainPricings.find((e) => e.domain === tld);
//   const amount = pricing?.register ?? 0;
...
//         <Content>
//           <Info><strong>Domain:</strong> {domain}{tld}</Info>
//           <Info><strong>Amount:</strong> ₦{amount.toLocaleString()}</Info>
//         </Content>

//         <Actions>
//           <ButtonPrimary>Pay Now</ButtonPrimary>
//           <ButtonSecondary onClick={onClose}>Cancel</ButtonSecondary>
//         </Actions>
//       </ModalContainer>
//     </Overlay>,
